package com.resonant.wrapper.lib.render.fx;
...
public class FxBeam extends EntityFX {
	...
	public FxBeam(ResourceLocation texture, World par1World, Vector3d position, Vector3d target2, Color color, int age) {
